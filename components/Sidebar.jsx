...
const Sidebar = ({ show, setShow }) => {
  return (
    <div className="md:sticky md:top-0 md:h-screen md:w-full">
      <AnimatePresence>
        <motion.aside
          className="overflow-hidden bg-slate-800 backdrop-blur-xl px-12 md:px-8 lg:px-12 py-10 h-full fixed inset-y-0 left-0 w-3/4 shadow z-20 md:relative md:inset-auto md:h-full md:w-full md:shadow-none md:block"
          variants={sidebar}
          initial="hidden"
          animate="visible"
          exit="exit"
